...
public class MqttOptionService extends EnvironmentalService {
     ...
     * @return -
     */
    private SocketFactory getSocketFactory(String certificate, String password, CertificationType certificationType) {
        ...
        try {
          ...
          throw new CouldNotCreateMqttOptionException("No such algorithm, can not create MQTT options.", e);
        } catch (UnrecoverableKeyException e) {
            throw new CouldNotCreateMqttOptionException("Key in the keystore could not be restored, can not create MQTT options.", e);
        } catch (KeyStoreException e) {
            throw new CouldNotCreateMqttOptionException("Generic keystore error, can not create MQTT options.", e);
        } catch (KeyManagementException e) {
            throw new CouldNotCreateMqttOptionException("Generic key management error, can not create MQTT options.", e);
        }
    }
}

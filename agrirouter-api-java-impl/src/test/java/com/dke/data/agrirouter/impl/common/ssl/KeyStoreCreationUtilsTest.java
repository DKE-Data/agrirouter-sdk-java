...
class KeyStoreCreationUtilsTest {
  ...
  void givenValidPEM_CreateAndReturnKeystoreFromPEM_ShouldReturnKeyStore() {
    ...
    KeyStore keyStore = KeyStoreCreationUtils.createAndReturnKeystoreFromPEM(certificate, secret);
  ...
  void givenInvalidPEM_CreateAndReturnKeystoreFromPEM_ShouldFail() {
    ...
    assertThrows(
        ...
        () -> KeyStoreCreationUtils.createAndReturnKeystoreFromPEM(certificate, secret));
  }
  ...
  void givenValidP12_CreateAndReturnKeystoreFromP12_ShouldReturnKeyStore() {
    ...
    KeyStore keyStore = KeyStoreCreationUtils.createAndReturnKeystoreFromP12(certificate, secret);
    assertNotNull(keyStore);
  }
  ...
  void givenInvalidP12_CreateAndReturnKeystoreFromP12_ShouldFail() {
    ...
    assertThrows(
        CouldNotCreateDynamicKeyStoreException.class,
        () -> KeyStoreCreationUtils.createAndReturnKeystoreFromP12(certificate, secret));
  }
  ...
  void givenValidCertificateAndPrivateKey_CreateKeyStoreInClasspath_ShouldReturnTmpKeystoreName()
    ...
    X509Certificate certificate =
        KeyStoreCreationUtils.createCertificate(
    ...
    PrivateKey privateKey =
        KeyStoreCreationUtils.createPrivateKey(
    ...
    String tmpKeystoreName =
        KeyStoreCreationUtils.createKeyStoreInClasspath(certificate, privateKey);
  ...
  void givenValidEncryptedPrivateKey_CreatePrivateKey_ShouldReturnPrivateKey() throws Throwable {
    ...
    String encryptedPrivateKey =
        "";
    PrivateKey privateKey = KeyStoreCreationUtils.createPrivateKey(encryptedPrivateKey, secret);
  ...
  void givenInvalidEncryptedPrivateKey_CreatePrivateKey_ShouldFail() {
    ...
    assertThrows(
        ...
        () -> KeyStoreCreationUtils.createPrivateKey(encryptedPrivateKey, secret));
  }
  ...
  void givenValidEncryptedCertificate_CreateCertificate_ShouldReturnCertificate() throws Throwable {
    ...
    X509Certificate certificate = KeyStoreCreationUtils.createCertificate(encryptedCertificate);
  ...
  void givenInvalidEncryptedCertificate_CreateCertificate_ShouldFail() {
    ...
    assertThrows(
        IllegalArgumentException.class,
        () -> KeyStoreCreationUtils.createCertificate(encryptedCertificate));
  }
}

...
class SendMessageServiceImplTest {
    ...
    private static final String CERTIFICATE_CERTIFICATE = "-----BEGIN ENCRYPTED PRIVATE KEY-----\n" +
    ...
    private static final String CERTIFICATE_PRIVATE_KEY = "-----BEGIN CERTIFICATE-----\n" +
    ...
    private static final String MEASURES = "https://dke-dev.eu10.cp.iot.sap/iot/gateway/rest/measures/e19aa55c-998b-42db-a223-41e436d9bb3b";
    ...
    void rq43_givenEmptyParams_Send_ShouldThrowException() {
        ...
        assertThrows(IllegalParameterDefinitionException.class, () -> sendMessageService.send(sendMessageParameters));
    }
    ...
    void rq43_givenEmptyCertificate_Send_ShouldThrowException() {
        ...
        assertThrows(CouldNotCreateDynamicKeyStoreException.class, () -> sendMessageService.send(sendMessageParameters));
    }
    ...
    void rq43_givenCertificateWithMissingPrivateKey_Send_ShouldThrowException() {
        SendMessageServiceImpl sendMessageService = new SendMessageServiceImpl();
        SendMessageParameters sendMessageParameters = this.createDefaultParameters();
        sendMessageParameters.getOnboardingResponse().getAuthentication().setCertificate(CERTIFICATE_CERTIFICATE);
        assertThrows(CouldNotCreateDynamicKeyStoreException.class, () -> sendMessageService.send(sendMessageParameters));
    }
    ...
    void rq43_givenCertificateOnlyPrivateKey_Send_ShouldThrowException() {
        SendMessageServiceImpl sendMessageService = new SendMessageServiceImpl();
        SendMessageParameters sendMessageParameters = this.createDefaultParameters();
        sendMessageParameters.getOnboardingResponse().getAuthentication().setCertificate(CERTIFICATE_PRIVATE_KEY);
        assertThrows(CouldNotCreateDynamicKeyStoreException.class, () -> sendMessageService.send(sendMessageParameters));
    }
    ...
    void rq43_givenWrongCertificationType_Send_ShouldThrowException() {
        SendMessageServiceImpl sendMessageService = new SendMessageServiceImpl();
        SendMessageParameters sendMessageParameters = this.createDefaultParameters();
        sendMessageParameters.getOnboardingResponse().getAuthentication().setType(CertificationType.P12.getKey());
        assertThrows(CouldNotCreateDynamicKeyStoreException.class, () -> sendMessageService.send(sendMessageParameters));
    }
    ...
    private SendMessageParameters createDefaultParameters() {
        ...
        authentication.setCertificate(SendMessageServiceImplTest.CERTIFICATE_PRIVATE_KEY + SendMessageServiceImplTest.CERTIFICATE_CERTIFICATE);

...
public class MessageQueryService extends MqttService
    ...
    public MessageQueryService(
            MqttClient mqttClient, EncodeMessageService encodeMessageService, TechnicalMessageType technicalMessageType) {
        super(mqttClient);
        this.logMethodBegin();

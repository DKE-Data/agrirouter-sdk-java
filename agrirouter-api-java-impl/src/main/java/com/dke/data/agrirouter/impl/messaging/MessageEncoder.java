...
public interface MessageEncoder extends LoggingEnabledService {
    ...
    default EncodedMessage encode(DeleteMessageParameters parameters) {
        ...
        messageHeaderParameters.setApplicationMessageSeqNo(parameters.getSequenceNumber() != 0 ? parameters.getSequenceNumber() : SequenceNumberService.generateSequenceNumberForEndpoint(parameters.getOnboardingResponse()));

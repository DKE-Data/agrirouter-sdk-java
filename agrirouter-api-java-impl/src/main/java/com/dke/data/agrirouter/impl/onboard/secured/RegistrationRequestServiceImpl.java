...
public class RegistrationRequestServiceImpl extends EnvironmentalService implements RegistrationRequestService, ResponseValidator {
    ...
    @Override
    public RegistrationRequestResponse getRegistrationCode(SecuredRegistrationRequestParameters securedRegistrationRequestParameters) {
        ...
        authenticationUrlParameters.setApplicationId(securedRegistrationRequestParameters.getApplicationId());
        authenticationUrlParameters.setRedirectUri(securedRegistrationRequestParameters.getRedirectUri());
        ...
        try (final WebClient webClient = new WebClient()) {
            ...
            final String url = this.onboardingService.generateAuthenticationUrl(authenticationUrlParameters);
            ...
            throw new CouldNotGetRegistrationCodeException("The provided application id was not valid.", e);
        }
    }
    ...
    private RegistrationRequestResponse extractAuthenticationResults(URL redirectPageUrl) {
        ...
        Arrays.stream(queryParams).forEach(s -> {
            ...
            try {
                authenticationResults.put(keyValuePair[0], URLDecoder.decode(keyValuePair[1], "UTF-8"));

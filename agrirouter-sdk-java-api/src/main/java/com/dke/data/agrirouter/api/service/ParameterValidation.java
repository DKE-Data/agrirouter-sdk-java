...
public interface ParameterValidation {
    ...
    default void nullCheck(String parameterName, Object o) {
        if (null == o) {
            this.rise("The parameter '%s' should not have been null, please check your values.", parameterName);
        }
    }
    ...
    default void isBlank(String parameterName, String s) {
        if (StringUtils.isBlank(s)) {
            this.rise("The parameter '%s' should not have been blank, please check your values.", parameterName);
        }
    }
    ...
    default void nullOrEmpty(String parameterName, Collection<?> c) {
        ...
        if (c.isEmpty()) {
            this.rise("The parameter '%s' should not have been empty, please check your values.", parameterName);
        }
    }
}

...
/**
 * Will be thrown if there are any problems with the message decoding itself - possible I/O exceptions during byte array output stream generation for example.
 */

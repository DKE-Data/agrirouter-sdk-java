...
public interface FetchMessageService {
    ...
    /**
     * Fetch messages using the given onboarding response using the number of tries and the given interval.
     *
     ...
     */
    Optional<List<FetchMessageResponse>> fetch(OnboardingResponse onboardingResponse, int maxTries, long interval);
     ...
     * @return Native response.
     */
    Optional<List<FetchMessageResponse>> fetch(FetchMessageParameters parameters, int maxTries, long interval);

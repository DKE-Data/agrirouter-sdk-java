...
class CloudOffboardingServiceTest extends AbstractIntegrationTest {
    ...
    void onboardVirtualCu() throws Throwable {
        ...
        CloudOnboardingParameters.EndpointDetailsParameters endpointDetails = new CloudOnboardingParameters.EndpointDetailsParameters();
        ...
        DecodeCloudOnboardingResponsesService decodeCloudOnboardingResponsesService = new DecodeCloudOnboardingResponsesService();
        List<OnboardingResponse> onboardingResponses = decodeCloudOnboardingResponsesService.decode(fetchMessageResponses.get(), getOnboardingResponse());
    ...
    @Test
    void givenValidSensorIdWhenOffboardingVirtualCuThenTheOffbardingShouldBeSuccessful() throws Throwable {
        ...
        parameters.setEndpointIds(Collections.singletonList(virtualCommunicationUnit.getSensorAlternateId()));
        parameters.setOnboardingResponse(getOnboardingResponse());

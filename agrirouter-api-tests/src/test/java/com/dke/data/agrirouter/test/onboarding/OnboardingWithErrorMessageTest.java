...
class OnboardingWithErrorMessageTest extends AbstractIntegrationTest {
    ...
    @Test
    void givenInvalidRegistrationCodeWhenSendingTheOnboardingRequestThenThereShouldBeAnOnboardingExceptionWithFilledErrorMessage() {
        ...
        OnboardingException onboardingException = Assertions.assertThrows(OnboardingException.class, () -> onboardingService.onboard(onboardingParameters));
        ...
        Assertions.assertEquals("Bearer not found.", onboardingException.getOnboardingError().getError().getMessage());
    }

...
class SetCapabilityServiceImplTest extends AbstractIntegrationTest {
  ...
  void givenValidEndpointWhenSendingCapabilitiesTheCapabilityMessageShouldBeAccepted()
    ...
    parameters.setApplicationId(this.getApplicationId());
    parameters.setCertificationVersionId(this.getCertificationVersionId());
  ...
  private OnboardingResponse getOnboardingResponse() {
    ...
    OnboardingResponse onboardingResponse =
        gson.fromJson(onboardingResponseAsJson, OnboardingResponse.class);
